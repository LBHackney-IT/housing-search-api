...
[assembly: SuppressMessage("Usage", "CA2211:Non-constant fields should not be visible", Justification = "<Pending>", Scope = "member", Target = "~F:HousingSearchApi.Tests.V1.E2ETests.Fixtures.AssetFixture.Addresses")]
...
[assembly: SuppressMessage("Usage", "CA2211:Non-constant fields should not be visible", Justification = "<Pending>", Scope = "member", Target = "~F:HousingSearchApi.Tests.V1.E2ETests.Fixtures.StaffFixture.Staffs")]
[assembly: SuppressMessage("Usage", "CA2211:Non-constant fields should not be visible", Justification = "<Pending>", Scope = "member", Target = "~F:HousingSearchApi.Tests.V1.E2ETests.Fixtures.ProcessFixture.Processes")]
[assembly: SuppressMessage("Usage", "CA2211:Non-constant fields should not be visible", Justification = "<Pending>", Scope = "member", Target = "~F:HousingSearchApi.Tests.V1.E2ETests.Fixtures.ProcessFixture.RelatedEntities")]
[assembly: SuppressMessage("Usage", "CA2211:Non-constant fields should not be visible", Justification = "<Pending>", Scope = "member", Target = "~F:HousingSearchApi.Tests.V1.E2ETests.Fixtures.ProcessFixture._patchAssignment")]
[assembly: SuppressMessage("Usage", "CA2211:Non-constant fields should not be visible", Justification = "<Pending>", Scope = "member", Target = "~F:HousingSearchApi.Tests.V1.E2ETests.Fixtures.ProcessFixture.PatchAssignment")]
