...
using Nest;
using Xunit;
using QueryablePerson = HousingSearchApi.V1.Gateways.Models.QueryablePerson;
...
namespace HousingSearchApi.Tests.V1.Helper
{
    public class SearchFirstNamesTests
    {
        ...
        public void ShouldReturnQueryThatSearchesForNames()
        {
            ...
            // Assert
            (result as IQueryContainer).Wildcard.Field.Expression.Print().Should().Be("f => f.Firstname");
