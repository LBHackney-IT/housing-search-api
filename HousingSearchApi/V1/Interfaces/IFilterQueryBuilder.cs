...
namespace HousingSearchApi.V1.Interfaces
{
    public interface IFilterQueryBuilder<T> : IQueryBuilder<T> where T : class
    {
        ...
        public IFilterQueryBuilder<T> WithWildstarBoolQuery(string searchText, List<string> fields, int? minimumShouldMatch = null, TextQueryType textQueryType = TextQueryType.MostFields);
